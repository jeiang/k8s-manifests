...
- CrowdSec WAF is loaded as a Traefik plugin and dynamic file-provider middleware.
- The `kube-system/traefik-crowdsec-dynamic` Secret must exist before applying this config.
...
- Do not commit CrowdSec bouncer keys in this file; keep them in the Bitwarden-synced dynamic config Secret.
